...
class KParseArgs():
    ...
    def __init__(self):
        ...
        self.parser.add_argument("--hidden_layers", help="Number of Hidden Layers", action='store', nargs='?', default=2,
                            type=int)
        ...
        self.parser.add_argument("--tracking_server", help="Specify the MLflow Tracking Server", nargs='?', action='store', default='sqlite:///mlflow.db', type=str)
        self.parser.add_argument("--experiment_name", help="Name of the MLflow Experiment for the runs", nargs='?', action='store', default='Keras_XRay_Classifier', type=str)
